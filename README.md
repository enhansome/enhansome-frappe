...
* [CRM](https://github.com/frappe/crm) ⭐ 3,582 | 🐛 277 | 🌐 Vue | 📅 2026-09-23 - Fully featured, open source CRM.
* [School](https://github.com/frappe/lms) ⭐ 3,252 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-23 - The Learning Management System (LMS) that powers [mon.school](https://mon.school) & [frappe.school](https://frappe.school).
* [Frappe Insights](https://github.com/frappe/insights) ⭐ 1,019 | 🐛 231 | 🌐 Python | 📅 2026-09-23 -  Free and Open Source Data Analytics Tool for your Frappe Apps
* [Education](https://github.com/frappe/education) ⭐ 646 | 🐛 148 | 🌐 Python | 📅 2026-09-23 - Open source education / school management system.
...
* [Gameplan](https://github.com/frappe/gameplan/) ⭐ 516 | 🐛 74 | 🌐 Python | 📅 2026-09-23 - Delightful, open-source, work communication tool for remote teams.
* [URY - Open Source Restaurant Management System](https://github.com/ury-erp/ury) ⭐ 374 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-23 - URY is an open-source ERP designed to simplify and streamline restaurant operations, built over ERPNext.
* [Lending](https://github.com/frappe/lending) ⭐ 348 | 🐛 22 | 🌐 Python | 📅 2026-09-23 - Open Source Lending software.
...
* [Cargo Management](https://github.com/AgileShift/cargo_management) ⭐ 122 | 🐛 2 | 🌐 Python | 📅 2026-09-03 - Package Management App for ERPNext.
...
* [Discipline HR](https://github.com/cre8tivMaxx/discipline_hr) ⭐ 7 | 🐛 13 | 🌐 Python | 📅 2026-05-18 - Advanced attendance discipline, grace management and automated payroll penalties for ERPNext HRMS
* [DeskAllocationSystem](https://github.com/yashtilala412/Desk_Allocation_System) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-03-01 - A gamified office management app for Frappe/ERPNext that automates quarterly team seating shuffles with a randomized desk-to-employee distribution engine.
...
* [POSNext](https://github.com/BrainWise-DEV/POSNext.git) ⭐ 158 | 🐛 15 | 🌐 Vue | 📅 2026-09-23 - POSNext is a modern, open-source Point of Sale for ERPNext, offering fast billing, multiple payment methods, smart discounts, offline mode, and a clean touchscreen-friendly UI—built to handle real retail operations with speed and reliability.
...
* [X POS](https://github.com/kodlyft/xpos.git) ⭐ 41 | 🐛 7 | 🌐 Python | 📅 2026-09-23 - X POS is a feature-rich, offline-first Point of Sale application built on Frappe and ERPNext. It delivers a fast, keyboard-driven, and fully offline-capable POS experience for retail, hospitality, and service businesses — deployable as a web app, PWA, or Electron desktop application.
...
* [Raven](https://github.com/The-Commit-Company/Raven) ⭐ 794 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-23 - Simple, open source team messaging platform built for Frappe.
* [Print Designer](https://github.com/frappe/print_designer) ⭐ 453 | 🐛 148 | 🌐 JavaScript | 📅 2026-09-19 - Frappe app to design print formats using interactive UI.
* [Wiki](https://github.com/frappe/wiki) ⭐ 434 | 🐛 25 | 🌐 Python | 📅 2026-09-23 - Wiki for serving dynamic data along with a built-in review system.
...
* [Go1 CMS](https://github.com/TridotsTech/go1cms) ⭐ 61 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-23 - Advanced Content Management System built on Frappe.
* [Pibicut](https://github.com/pibico/pibicut) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2026-02-04 - URL Shortener with QR Code Generator.
...
* [ProjectIT](https://github.com/Arus-Info/ProjectIT) ⭐ 33 | 🐛 2 | 🌐 Vue | 📅 2026-07-13 - Open Source PWA mobile app to track the Employees out in the field.
...
* [Ghost](https://github.com/muneeb141/ghost) ⭐ 28 | 🐛 0 | 🌐 Python | 📅 2026-08-05 -  Headless identity and OTP authentication engine for Frappe. Centralizes Guest Sessions, Secure Login, and seamless Ghost-to-Real User conversion for building modern Web & Mobile apps.
* [XcelForm](https://github.com/jezlan/xcelform) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2026-03-24 - A powerful app for Exporting Doctype data to Excel with custom formats in Frappe/ERPNext.
...
* [Private Comment](https://github.com/rtCamp/frappe-private-comment.git) ⭐ 18 | 🐛 7 | 🌐 Python | 📅 2026-09-23 - App that allows controlling comment visibility for tagged user and user-groups with three modes: Private, Public & Mentioned
...
* [Frappe Web Push](https://github.com/meichthys/frappe_web_push) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-05 - Enables native local browser toast notifications without the need for remote servers like firebase or frappe-cloud
...
* [Matcha](https://github.com/Negentropy-Solutions/matcha) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-26 - Faster payment reconciliation for ERPNext with a React UI, FX gain/loss preview, cross-company reconciliation, and undo support.
...
* [Mind Map](https://github.com/nilpatel42/mind_map) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-17 - Create, edit, and navigate interactive mind maps inside Frappe Desk for planning, documentation trees, and knowledge organization.
...
* [Jarvis](https://github.com/aerele/jarvis) ⭐ 93 | 🐛 50 | 🌐 Python | 📅 2026-09-23 - An AI teammate inside ERPNext. Ask about your business data in plain English, automate document processing with a human in the loop and save your team's best practices as reusable skills. It runs under each user's own permissions and can connect to your existing AI chat subscription.
* [changAI](https://github.com/ERPGulf/changAI) ⭐ 75 | 🐛 7 | 🌐 Python | 📅 2026-08-18 - AI-powered assistant for ERPNext that lets users ask business questions in plain English and get instant answers.
...
* [Ask ALYF](https://github.com/alyf-de/ask_alyf) ⭐ 28 | 🐛 21 | 🌐 Python | 📅 2026-09-14 - Ask ALYF adds an assistant to ERPNext so users can ask questions, find information, and get help working with documents without leaving the Desk.
...
* [Jodit HTML Editor](https://github.com/ashish-greycube/jodit_html_editor) ⭐ 24 | 🐛 5 | 🌐 Python | 📅 2024-04-10 - Replace Quill Text Editor With [Jodit](https://github.com/xdan/jodit) ⭐ 1,964 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-23 HTML Editor on WebPage and WebForm for Frappe/ERPNext Version 11 & 12.
...
* [BPMN Diagrams](https://github.com/geraldmeunier/frappe_bpmn_diagrams) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-04-18 - Adds a BPMN fieldtype to Frappe (powered by [bpmn.io](https://github.com/bpmn-io/bpmn-js) ⭐ 9,665 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-23) so you can draw BPMN diagrams on any DocType.
...
* [WhatsApp Integration](https://github.com/shridarpatil/frappe_whatsapp) ⭐ 479 | 🐛 10 | 🌐 Python | 📅 2026-08-04 - WhatsApp Cloud Integration for Frappe.
...
* [Ecommerce Integrations](https://github.com/frappe/ecommerce_integrations) ⭐ 210 | 🐛 132 | 🌐 Python | 📅 2026-09-23 - Ecommerce integrations for ERPNext (Shopify, Unicommerce, Zenoti).
* [Shopify Integration](https://github.com/frappe/ecommerce_integrations) ⭐ 210 | 🐛 132 | 🌐 Python | 📅 2026-09-23 - Shopify Integration for ERPNext.
* [Unicommerce Integration](https://github.com/frappe/ecommerce_integrations) ⭐ 210 | 🐛 132 | 🌐 Python | 📅 2026-09-23 - Unicommerce Integration for ERPNext.
* [Zenoti Integration](https://github.com/frappe/ecommerce_integrations) ⭐ 210 | 🐛 132 | 🌐 Python | 📅 2026-09-23 - Zenoti Integration for ERPNext.
* [ERPNext Shipping](https://github.com/frappe/erpnext-shipping) ⭐ 148 | 🐛 11 | 🌐 Python | 📅 2026-08-21 - Shipping Integration for ERPNext with Packlink, LetMeShip & SendCloud.
...
* [Dash Integration](https://github.com/pipech/frappe-plotly-dash) ⭐ 31 | 🐛 4 | 🌐 Python | 📅 2024-02-02 - Build analytical web apps through the Desk with @plotly's [Dash](https://github.com/plotly/dash) ⭐ 24,426 | 🐛 421 | 🌐 Python | 📅 2026-09-23.
...
* [Desk Theme](https://github.com/dhwani-ris/frappe_desk_theme) ⭐ 47 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-17 - Comprehensive theming solution for Frappe/ ERPNext v16 Apps.
...
* [India Compliance](https://github.com/resilient-tech/india-compliance) ⭐ 270 | 🐛 126 | 🌐 Python | 📅 2026-09-23 - Simple, yet powerful compliance solutions for Indian businesses.
* [Nepal Compliance](https://github.com/yarsa/nepal-compliance) ⭐ 175 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - Open source ERP for Nepal with HR, Payroll & Accounting compliance.
...
* [ERPNext France](https://github.com/scopen-coop/erpnext_france.git) ⭐ 27 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Regional code for France, built on top of ERPNext.
...
* [ERPNext Thailand](https://github.com/ecosoft-frappe/erpnext_thailand) ⭐ 25 | 🐛 15 | 🌐 Python | 📅 2026-09-11 - Thailand Taxation (VAT, WHT), Thai Billing Process, Get Address from Tax ID, Bank of Thailand Exchange Rate and more... for ERPNext.
...
* [Frappe UI](https://github.com/frappe/frappe-ui) ⭐ 1,035 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-23 - A set of components and utilities for rapid UI development.
* [Frappe-Manager (fm)](https://github.com/rtCamp/Frappe-Manager) ⭐ 419 | 🐛 75 | 🌐 Python | 📅 2026-09-23 - A powerful CLI tool to streamline the development and deployment of Frappe and ERPNext applications using Docker. Features quick environment setup, multi-bench/site management, VSCode integration, and production-ready SSL support—all from the command line.
...
* [Semgrep Rules](https://github.com/frappe/semgrep-rules) ⭐ 67 | 🐛 1 | 🌐 Python | 📅 2026-08-05 - Semgrep Rules for following the best practices while building your Frappe Apps.
...
* [Frappe Deployer](https://github.com/Henry-Do-Su/frappe_deployer) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2025-04-04 - Streamlined and efficient way to set up development and production environments for Frappe.
...
* [Optimus](https://github.com/aerele/optimus) ⭐ 11 | 🐛 2 | 🌐 Python | 📅 2026-09-23 - Traces why a business workflow is slow by following the whole chain of HTTP requests and background jobs it sets off. It produces a redacted report you can share and a raw one for debugging. It can also suggest fixes with an LLM.
...
* [Frappe Assistant Core](https://github.com/buildswithpaul/Frappe_Assistant_Core) ⭐ 314 | 🐛 4 | 🌐 Python | 📅 2026-09-23 - Infrastructure that connects LLMs to ERPNext with Model Context Protocol (MCP).
...
* [HUF AI](https://github.com/tridz-dev/huf) ⭐ 120 | 🐛 84 | 🌐 Python | 📅 2026-09-23 - Open-source AI infrastructure for any app. Build multi-agent solutions, automate AI driven deterministic workflows, and keep your data under your control.
* [MCP ERPNext](https://github.com/Casys-AI/mcp-erpnext) ⭐ 98 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-19 - MCP server for ERPNext with 97 tools across 11 categories and 7 interactive UI viewers. Zero-config setup via npx.
...
* [Frappe Docker](https://github.com/frappe/frappe_docker) ⭐ 2,574 | 🐛 11 | 🌐 Python | 📅 2026-09-22 - Official docker images for Frappe.
* [Frappe Operator](https://github.com/vyogotech/frappe-operator) ⭐ 53 | 🐛 0 | 🌐 Go | 📅 2026-09-23 - Kubernetes operator for automated deployment and management of Frappe/ERPNext.
...
* [Press](https://github.com/frappe/press) ⭐ 568 | 🐛 761 | 🌐 Python | 📅 2026-09-23 - Full service cloud hosting for the Frappe stack - powers Frappe Cloud
